...
namespace Server.Database
{
    public class DatabaseQueries : IDisposable
    {
        ...
        {
            if (database.ExecuteQuery("SELECT * FROM users WHERE password='@0' and name='@1';", user.PasswordHash, user.Name).Count != 1) return false;
        ...
        public int RegisterUser(User user) => database.ExecuteNonQuery("INSERT INTO users(name, password) VALUES ('@1', '@2');", user.Name, user.PasswordHash);
